...
const contract_name = 'DistributionPolicyV1'
...
async function main() {
    ...
    const [new_contract, new_contract_proxy_contract] = await deploy_proxy_contract(contract_name, admin_wallet, initialize_function, [Treasury_data.address])
