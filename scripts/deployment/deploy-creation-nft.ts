...
async function main() {
    ...
    const contract = await deploy_contract_to_file(admin_wallet, contract_name, ['Creation NFT', 'CREATION', 'ipfs://bafybeifitgcwguqqvuiycjsxepvtjp3ix43ofrkm65kz2shea2fzqcee4i/']);
